    ...
    return(
        <div className="flex flex-col body p-4">
            ...
            <div className="flex gap-5">
                ...
                <div className="flex-1">
                    <span className="text-xl body-heading font-bold">Midlothian Meeples</span>
                    <p><a class="underline text-sky-600 after:content-['_↗']" target="_blank" href="https://midlothianmeeples.games">midlothianmeeples.games</a></p>
                    ...
                    <p>I decided to host this on Vercel as it seems to be a popular hosting solution and I thought the experience with it would prove useful</p>
                </div>
            </div>
        </div>
    )
